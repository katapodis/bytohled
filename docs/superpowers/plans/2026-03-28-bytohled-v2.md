...
- [ ] **Krok 1: Vytvoř `dashboard/app/api/listing/[id]/route.ts`**
...
- [ ] **Krok 4: Přidej GET do `dashboard/app/api/listing/[id]/route.ts`**
...
git commit -m "feat: listing detail page with favorite toggle and note auto-save"
```
